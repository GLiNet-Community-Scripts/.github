...
- `1,975` GitHub stars in total
- Automatically updated on `26 Aug 2026, 07:49`
...
| [docs4.x](https://github.com/GLiNet-Community-Scripts/docs4.x) | GL.iNet router documentation v4.x - setup guides, tutorials, and FAQs | 127 | gl-inet | [gl-inet/docs4.x](https://github.com/gl-inet/docs4.x) | 17 Aug 2026 |
...
| [GL.iNet-ExternalUSB-Logs](https://github.com/GLiNet-Community-Scripts/GL.iNet-ExternalUSB-Logs) | Redirect logs to external USB storage on GL.iNet routers | 1 | zippyy | [zippyy/GL.iNet-ExternalUSB-Logs](https://github.com/zippyy/GL.iNet-ExternalUSB-Logs) | 17 Aug 2026 |
...
| [GL.iNET-Toggle-Switch](https://github.com/GLiNet-Community-Scripts/GL.iNET-Toggle-Switch) | UI toggle switch component for GL.iNet routers | 1 | zippyy | [zippyy/GL.iNET-Toggle-Switch](https://github.com/zippyy/GL.iNET-Toggle-Switch) | 17 Aug 2026 |
...
| [glikvm-mod](https://github.com/GLiNet-Community-Scripts/glikvm-mod) | Patches for the GLKVM Windows desktop client: sessions in separate windows, paste local clipboard into the remote machine, settings UI | 0 | emaspa | [emaspa/glikvm-mod](https://github.com/emaspa/glikvm-mod) | 23 Aug 2026 |
...
| [glinet-adguard-updater](https://github.com/GLiNet-Community-Scripts/glinet-adguard-updater) | This script updates the AdGuard Home installation on GL.iNet routers. | 147 | admonstrator | [admonstrator/glinet-adguard-updater](https://github.com/admonstrator/glinet-adguard-updater) | 20 Apr 2026 |
...
| [glinet-tailscale-updater](https://github.com/GLiNet-Community-Scripts/glinet-tailscale-updater) | This script updates the Tailscale installation on GL.iNet routers. | 707 | admonstrator | [admonstrator/glinet-tailscale-updater](https://github.com/admonstrator/glinet-tailscale-updater) | 5 Aug 2026 |
...
| [glkvm](https://github.com/GLiNet-Community-Scripts/glkvm) | GL.iNet KVM firmware for remote control and management | 220 | gl-inet | [gl-inet/glkvm](https://github.com/gl-inet/glkvm) | 17 Aug 2026 |
| [glkvm-cloud](https://github.com/GLiNet-Community-Scripts/glkvm-cloud) | Self-Deployed Lightweight KVM Cloud | 291 | gl-inet | [gl-inet/glkvm-cloud](https://github.com/gl-inet/glkvm-cloud) | 10 Jul 2026 |
...
| [OpenSpeedTestServer](https://github.com/GLiNet-Community-Scripts/OpenSpeedTestServer) | Deploy OpenSpeedTest with NGINX on GL.iNet OpenWrt routers — auto-install, persistence across firmware updates, external storage support, and clean uninstall. | 0 | GLiNet-Community-Scripts | [GLiNet-Community-Scripts/OpenSpeedTestServer](https://github.com/GLiNet-Community-Scripts/OpenSpeedTestServer) | 25 Aug 2026 |
...
| [RM520N-GL](https://github.com/GLiNet-Community-Scripts/RM520N-GL) | Quectel RM520N-GL is 5G IoT module specially optimized for IoT/eMBB applications. | 241 | 4IceG | [4IceG/RM520N-GL](https://github.com/4IceG/RM520N-GL) | 28 Jul 2026 |
